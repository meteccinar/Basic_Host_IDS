...
public class Key {
 ...
 public String decryptedFile(String secretKey, String fileInputPath) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, IOException,IllegalBlockSizeException, BadPaddingException 
 {
	  var key = new SecretKeySpec(secretKey.getBytes(), "AES");
	  var cipher = Cipher.getInstance("AES");
	  ...
	  String s = new String(outputBytes, StandardCharsets.UTF_8);	  
